...
namespace AutoGenerated2
{
	...
	{
		public override MessageHeader MessageHeader { get { throw this.NullAccess("MessageHeader"); } }
		public override string PublicationDate { get { throw this.NullAccess("PublicationDate"); } }
	...
	public partial class CatalogTransfer
	{
		...
		{
			CatalogTransferCompleted = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "CatalogTransferCompleted").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "CatalogTransferCompleted").Select(e => e.Value).SingleOrDefault());
	...
	public partial class Collection
	{
		...
		public Collection(XElement element)
		{
			...
			IsComplete = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "IsComplete").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "IsComplete").Select(e => e.Value).SingleOrDefault());
	...
	public partial class Cue
	{
		...
		public Cue(XElement element)
		{
			...
			IsDance = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "IsDance").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "IsDance").Select(e => e.Value).SingleOrDefault());
			...
			HasMusicalContent = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "HasMusicalContent").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "HasMusicalContent").Select(e => e.Value).SingleOrDefault());
	...
	public partial class DealTerms
	{
		...
		public DealTerms(XElement element)
		{
			...
			AllDealsCancelled = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "AllDealsCancelled").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "AllDealsCancelled").Select(e => e.Value).SingleOrDefault());
			TakeDown = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "TakeDown").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "TakeDown").Select(e => e.Value).SingleOrDefault());
			TerritoryCodes = element.Elements().Where(e => e.Name == "TerritoryCode").Select(e => e.Value).ToList();
			ExcludedTerritoryCodes = element.Elements().Where(e => e.Name == "ExcludedTerritoryCode").Select(e => e.Value).ToList();
			...
			IsPromotional = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "IsPromotional").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "IsPromotional").Select(e => e.Value).SingleOrDefault());
			...
			IsExclusive = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "IsExclusive").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "IsExclusive").Select(e => e.Value).SingleOrDefault());
			...
			NumberOfProductsPerCarton = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "NumberOfProductsPerCarton").Select(e => e.Value).SingleOrDefault()) ? null : (int?)int.Parse(element.Elements().Where(e => e.Name == "NumberOfProductsPerCarton").Select(e => e.Value).SingleOrDefault());
	...
	public partial class Image
	{
		...
		public Image(XElement element)
		{
			...
			IsArtistRelated = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "IsArtistRelated").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "IsArtistRelated").Select(e => e.Value).SingleOrDefault());
			...
			IsUpdated = string.IsNullOrEmpty(element.Attributes().Where(e => e.Name == "IsUpdated").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Attributes().Where(e => e.Name == "IsUpdated").Select(e => e.Value).SingleOrDefault());
			LanguageAndScriptCode = element.Attributes().Where(e => e.Name == "LanguageAndScriptCode").Select(e => e.Value).SingleOrDefault();
		}
	...
	public partial class MIDI
	{
		...
		public MIDI(XElement element)
		{
			...
			IsMedley = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "IsMedley").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "IsMedley").Select(e => e.Value).SingleOrDefault());
			IsPotpourri = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "IsPotpourri").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "IsPotpourri").Select(e => e.Value).SingleOrDefault());
			IsInstrumental = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "IsInstrumental").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "IsInstrumental").Select(e => e.Value).SingleOrDefault());
			IsBackground = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "IsBackground").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "IsBackground").Select(e => e.Value).SingleOrDefault());
			IsHiddenResource = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "IsHiddenResource").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "IsHiddenResource").Select(e => e.Value).SingleOrDefault());
			IsBonusResource = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "IsBonusResource").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "IsBonusResource").Select(e => e.Value).SingleOrDefault());
			IsComputerGenerated = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "IsComputerGenerated").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "IsComputerGenerated").Select(e => e.Value).SingleOrDefault());
			NoSilenceBefore = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "NoSilenceBefore").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "NoSilenceBefore").Select(e => e.Value).SingleOrDefault());
			NoSilenceAfter = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "NoSilenceAfter").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "NoSilenceAfter").Select(e => e.Value).SingleOrDefault());
			PerformerInformationRequired = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "PerformerInformationRequired").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "PerformerInformationRequired").Select(e => e.Value).SingleOrDefault());
	...
	public partial class PhysicalReturns
	{
		...
		{
			PhysicalReturnsAllowed = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "PhysicalReturnsAllowed").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "PhysicalReturnsAllowed").Select(e => e.Value).SingleOrDefault());
			LatestDateForPhysicalReturns = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "LatestDateForPhysicalReturns").Select(e => e.Value).SingleOrDefault()) ? null : (DateTime?)DateTime.Parse(element.Elements().Where(e => e.Name == "LatestDateForPhysicalReturns").Select(e => e.Value).SingleOrDefault());
		}
	...
	public partial class PreviewDetails
	{
		...
		public virtual string TopLeftCorner { get; set; }
		public virtual string BottomRightCorner { get; set; }
	...
	internal class NullPreviewDetails : PreviewDetails
	{
		...
		public override string TopLeftCorner { get { throw this.NullAccess("TopLeftCorner"); } }
		public override string BottomRightCorner { get { throw this.NullAccess("BottomRightCorner"); } }
	...
	public partial class ReleaseDeal
	{
		...
		public ReleaseDeal(XElement element)
		{
			...
			Deals = element.Elements().Where(e => e.Name == "Deal").Select(e => new Deal(e)).ToList();
			EffectiveDate = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "EffectiveDate").Select(e => e.Value).SingleOrDefault()) ? null : (DateTime?)DateTime.Parse(element.Elements().Where(e => e.Name == "EffectiveDate").Select(e => e.Value).SingleOrDefault());
			LanguageAndScriptCode = element.Attributes().Where(e => e.Name == "LanguageAndScriptCode").Select(e => e.Value).SingleOrDefault();
		}
	...
	public partial class ReleaseDetailsByTerritory
	{
		...
		public ReleaseDetailsByTerritory(XElement element)
		{
			...
			Titles = element.Elements().Where(e => e.Name == "Title").Select(e => new Title(e)).ToList();
			DisplayArtists = element.Elements().Where(e => e.Name == "DisplayArtist").Select(e => new Artist(e)).ToList();
			IsMultiArtistCompilation = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "IsMultiArtistCompilation").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "IsMultiArtistCompilation").Select(e => e.Value).SingleOrDefault());
			...
			Synopsis = element.Elements().Where(e => e.Name == "Synopsis").Select(e => new Synopsis(e)).SingleOrDefault() ?? new NullSynopsis();
			Characters = element.Elements().Where(e => e.Name == "Character").Select(e => new Character(e)).ToList();
			NumberOfUnitsPerPhysicalRelease = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "NumberOfUnitsPerPhysicalRelease").Select(e => e.Value).SingleOrDefault()) ? null : (int?)int.Parse(element.Elements().Where(e => e.Name == "NumberOfUnitsPerPhysicalRelease").Select(e => e.Value).SingleOrDefault());
			LanguageAndScriptCode = element.Attributes().Where(e => e.Name == "LanguageAndScriptCode").Select(e => e.Value).SingleOrDefault();
		}
	...
	public partial class ResourceGroup
	{
		...
		{
			Titles = element.Elements().Where(e => e.Name == "Title").Select(e => new Title(e)).ToList();
			SequenceNumber = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "SequenceNumber").Select(e => e.Value).SingleOrDefault()) ? null : (int?)int.Parse(element.Elements().Where(e => e.Name == "SequenceNumber").Select(e => e.Value).SingleOrDefault());
			DisplayArtists = element.Elements().Where(e => e.Name == "DisplayArtist").Select(e => new Artist(e)).ToList();
			ResourceContributors = element.Elements().Where(e => e.Name == "ResourceContributor").Select(e => new ResourceContributor(e)).ToList();
			IndirectResourceContributors = element.Elements().Where(e => e.Name == "IndirectResourceContributor").Select(e => new IndirectResourceContributor(e)).ToList();
			ResourceGroups = element.Elements().Where(e => e.Name == "ResourceGroup").Select(e => new ResourceGroup(e)).ToList();
	...
	public partial class ResourceGroupContentItem
	{
		...
		{
			SequenceNumber = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "SequenceNumber").Select(e => e.Value).SingleOrDefault()) ? null : (int?)int.Parse(element.Elements().Where(e => e.Name == "SequenceNumber").Select(e => e.Value).SingleOrDefault());
			SequenceSubNumber = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "SequenceSubNumber").Select(e => e.Value).SingleOrDefault()) ? null : (int?)int.Parse(element.Elements().Where(e => e.Name == "SequenceSubNumber").Select(e => e.Value).SingleOrDefault());
	...
	{
		public override Description PartType { get { throw this.NullAccess("PartType"); } }
		public override string StartPoint { get { throw this.NullAccess("StartPoint"); } }
		public override string EndPoint { get { throw this.NullAccess("EndPoint"); } }
		public override string Duration { get { throw this.NullAccess("Duration"); } }
		public override string TopLeftCorner { get { throw this.NullAccess("TopLeftCorner"); } }
		public override string BottomRightCorner { get { throw this.NullAccess("BottomRightCorner"); } }
		public override string ExpressionType { get { throw this.NullAccess("ExpressionType"); } }
	...
	public partial class TechnicalImageDetails
	{
		...
		public TechnicalImageDetails(XElement element)
		{
			...
			ColorDepth = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "ColorDepth").Select(e => e.Value).SingleOrDefault()) ? null : (int?)int.Parse(element.Elements().Where(e => e.Name == "ColorDepth").Select(e => e.Value).SingleOrDefault());
			ImageResolution = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "ImageResolution").Select(e => e.Value).SingleOrDefault()) ? null : (int?)int.Parse(element.Elements().Where(e => e.Name == "ImageResolution").Select(e => e.Value).SingleOrDefault());
			IsPreview = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "IsPreview").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "IsPreview").Select(e => e.Value).SingleOrDefault());
	...
	internal class NullTechnicalImageDetails : TechnicalImageDetails
	{
		...
		public override string AspectRatio { get { throw this.NullAccess("AspectRatio"); } }
	...
	public partial class TechnicalMidiDetails
	{
		...
		public TechnicalMidiDetails(XElement element)
		{
			TechnicalResourceDetailsReference = element.Elements().Where(e => e.Name == "TechnicalResourceDetailsReference").Select(e => e.Value).SingleOrDefault();
			Duration = element.Elements().Where(e => e.Name == "Duration").Select(e => e.Value).SingleOrDefault();
			ResourceProcessingRequired = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "ResourceProcessingRequired").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "ResourceProcessingRequired").Select(e => e.Value).SingleOrDefault());
			...
			FileAvailabilityDescriptions = element.Elements().Where(e => e.Name == "FileAvailabilityDescription").Select(e => new Description(e)).ToList();
			Files = element.Elements().Where(e => e.Name == "File").Select(e => new File(e)).ToList();
			NumberOfVoices = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "NumberOfVoices").Select(e => e.Value).SingleOrDefault()) ? null : (int?)int.Parse(element.Elements().Where(e => e.Name == "NumberOfVoices").Select(e => e.Value).SingleOrDefault());
	...
	public partial class TechnicalSoundRecordingDetails
	{
		...
		public TechnicalSoundRecordingDetails(XElement element)
		{
			...
			NumberOfChannels = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "NumberOfChannels").Select(e => e.Value).SingleOrDefault()) ? null : (int?)int.Parse(element.Elements().Where(e => e.Name == "NumberOfChannels").Select(e => e.Value).SingleOrDefault());
			...
			BitsPerSample = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "BitsPerSample").Select(e => e.Value).SingleOrDefault()) ? null : (int?)int.Parse(element.Elements().Where(e => e.Name == "BitsPerSample").Select(e => e.Value).SingleOrDefault());
			Duration = element.Elements().Where(e => e.Name == "Duration").Select(e => e.Value).SingleOrDefault();
			ResourceProcessingRequired = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "ResourceProcessingRequired").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "ResourceProcessingRequired").Select(e => e.Value).SingleOrDefault());
			UsableResourceDuration = element.Elements().Where(e => e.Name == "UsableResourceDuration").Select(e => e.Value).SingleOrDefault();
			IsPreview = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "IsPreview").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "IsPreview").Select(e => e.Value).SingleOrDefault());
	...
	public partial class TechnicalVideoDetails
	{
		...
		public TechnicalVideoDetails(XElement element)
		{
			...
			NumberOfAudioChannels = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "NumberOfAudioChannels").Select(e => e.Value).SingleOrDefault()) ? null : (int?)int.Parse(element.Elements().Where(e => e.Name == "NumberOfAudioChannels").Select(e => e.Value).SingleOrDefault());
			...
			AudioBitsPerSample = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "AudioBitsPerSample").Select(e => e.Value).SingleOrDefault()) ? null : (int?)int.Parse(element.Elements().Where(e => e.Name == "AudioBitsPerSample").Select(e => e.Value).SingleOrDefault());
			Duration = element.Elements().Where(e => e.Name == "Duration").Select(e => e.Value).SingleOrDefault();
			ResourceProcessingRequired = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "ResourceProcessingRequired").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "ResourceProcessingRequired").Select(e => e.Value).SingleOrDefault());
			UsableResourceDuration = element.Elements().Where(e => e.Name == "UsableResourceDuration").Select(e => e.Value).SingleOrDefault();
			IsPreview = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "IsPreview").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "IsPreview").Select(e => e.Value).SingleOrDefault());
	...
	public partial class WebPolicy
	{
		...
		{
			Condition = element.Elements().Where(e => e.Name == "Condition").Select(e => new Condition(e)).SingleOrDefault() ?? new NullCondition();
			AccessBlockingRequested = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "AccessBlockingRequested").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "AccessBlockingRequested").Select(e => e.Value).SingleOrDefault());
			AccessLimitation = element.Elements().Where(e => e.Name == "AccessLimitation").Select(e => e.Value).SingleOrDefault();
			EmbeddingAllowed = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "EmbeddingAllowed").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "EmbeddingAllowed").Select(e => e.Value).SingleOrDefault());
			UserRatingAllowed = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "UserRatingAllowed").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "UserRatingAllowed").Select(e => e.Value).SingleOrDefault());
			UserCommentAllowed = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "UserCommentAllowed").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "UserCommentAllowed").Select(e => e.Value).SingleOrDefault());
			UserResponsesAllowed = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "UserResponsesAllowed").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "UserResponsesAllowed").Select(e => e.Value).SingleOrDefault());
			SyndicationAllowed = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "SyndicationAllowed").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "SyndicationAllowed").Select(e => e.Value).SingleOrDefault());
		}
	...
	{
		public override string Amount { get { throw this.NullAccess("Amount"); } }
	...
	public partial class Artist
	{
		...
		public Artist(XElement element)
		{
			...
			SequenceNumber = string.IsNullOrEmpty(element.Attributes().Where(e => e.Name == "SequenceNumber").Select(e => e.Value).SingleOrDefault()) ? null : (int?)int.Parse(element.Attributes().Where(e => e.Name == "SequenceNumber").Select(e => e.Value).SingleOrDefault());
		}
	...
	public partial class CollectionCollectionReference
	{
		...
		public virtual string Duration { get; set; }
		public virtual string EndTime { get; set; }
		public virtual string InclusionDate { get; set; }
	...
	internal class NullCollectionCollectionReference : CollectionCollectionReference
	{
		...
		public override string Duration { get { throw this.NullAccess("Duration"); } }
		public override string EndTime { get { throw this.NullAccess("EndTime"); } }
		public override string InclusionDate { get { throw this.NullAccess("InclusionDate"); } }
	}
	...
	public partial class CollectionCollectionReferenceList
	{
		...
		{
			NumberOfCollections = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "NumberOfCollections").Select(e => e.Value).SingleOrDefault()) ? null : (int?)int.Parse(element.Elements().Where(e => e.Name == "NumberOfCollections").Select(e => e.Value).SingleOrDefault());
	...
	public partial class CollectionId
	{
		...
		public CollectionId(XElement element)
		{
			...
			IsReplaced = string.IsNullOrEmpty(element.Attributes().Where(e => e.Name == "IsReplaced").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Attributes().Where(e => e.Name == "IsReplaced").Select(e => e.Value).SingleOrDefault());
		}
	...
	public partial class ConsumerRentalPeriod
	{
		...
		{
			Value = element.Value;
			IsExtensible = string.IsNullOrEmpty(element.Attributes().Where(e => e.Name == "IsExtensible").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Attributes().Where(e => e.Name == "IsExtensible").Select(e => e.Value).SingleOrDefault());
		}
	...
	public partial class EventDate
	{
		...
		{
			Value = string.IsNullOrEmpty(element.Value) ? null : (DateTime?)DateTime.Parse(element.Value);
			IsApproximate = string.IsNullOrEmpty(element.Attributes().Where(e => e.Name == "IsApproximate").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Attributes().Where(e => e.Name == "IsApproximate").Select(e => e.Value).SingleOrDefault());
			IsBefore = string.IsNullOrEmpty(element.Attributes().Where(e => e.Name == "IsBefore").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Attributes().Where(e => e.Name == "IsBefore").Select(e => e.Value).SingleOrDefault());
			IsAfter = string.IsNullOrEmpty(element.Attributes().Where(e => e.Name == "IsAfter").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Attributes().Where(e => e.Name == "IsAfter").Select(e => e.Value).SingleOrDefault());
	...
	public partial class FulfillmentDate
	{
		...
		{
			FulfillmentDateProp = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "FulfillmentDate").Select(e => e.Value).SingleOrDefault()) ? null : (DateTime?)DateTime.Parse(element.Elements().Where(e => e.Name == "FulfillmentDate").Select(e => e.Value).SingleOrDefault());
	...
	public partial class ICPN
	{
		...
		{
			Value = element.Value;
			IsEan = string.IsNullOrEmpty(element.Attributes().Where(e => e.Name == "IsEan").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Attributes().Where(e => e.Name == "IsEan").Select(e => e.Value).SingleOrDefault());
		}
	...
	internal class NullMessageAuditTrailEvent : MessageAuditTrailEvent
	{
		...
		public override string DateTime { get { throw this.NullAccess("DateTime"); } }
	}
	...
	public partial class MessageHeader
	{
		...
		public virtual string MessageCreatedDateTime { get; set; }
	...
	internal class NullMessageHeader : MessageHeader
	{
		...
		public override string MessageCreatedDateTime { get { throw this.NullAccess("MessageCreatedDateTime"); } }
	...
	public partial class MessageNotificationPeriod
	{
		...
		{
			StartDate = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "StartDate").Select(e => e.Value).SingleOrDefault()) ? null : (DateTime?)DateTime.Parse(element.Elements().Where(e => e.Name == "StartDate").Select(e => e.Value).SingleOrDefault());
			EndDate = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "EndDate").Select(e => e.Value).SingleOrDefault()) ? null : (DateTime?)DateTime.Parse(element.Elements().Where(e => e.Name == "EndDate").Select(e => e.Value).SingleOrDefault());
		}
	...
	public partial class NumberOfDataMismatchItems
	{
		...
		{
			Value = string.IsNullOrEmpty(element.Value) ? null : (int?)int.Parse(element.Value);
	...
	public partial class NumberOfSubscribers
	{
		...
		{
			Quantity = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "Quantity").Select(e => e.Value).SingleOrDefault()) ? null : (int?)int.Parse(element.Elements().Where(e => e.Name == "Quantity").Select(e => e.Value).SingleOrDefault());
			UseTypes = element.Elements().Where(e => e.Name == "UseType").Select(e => new UseType(e)).ToList();
			UserInterfaceTypes = element.Elements().Where(e => e.Name == "UserInterfaceType").Select(e => new UserInterfaceType(e)).ToList();
			DistributionChannelTypes = element.Elements().Where(e => e.Name == "DistributionChannelType").Select(e => new DistributionChannelType(e)).ToList();
			CarrierTypes = element.Elements().Where(e => e.Name == "CarrierType").Select(e => new CarrierType(e)).ToList();
	...
	public partial class PartyId
	{
		...
		public PartyId(XElement element)
		{
			Value = element.Value;
			Namespace = element.Attributes().Where(e => e.Name == "Namespace").Select(e => e.Value).SingleOrDefault();
			IsDPID = string.IsNullOrEmpty(element.Attributes().Where(e => e.Name == "IsDPID").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Attributes().Where(e => e.Name == "IsDPID").Select(e => e.Value).SingleOrDefault());
			IsISNI = string.IsNullOrEmpty(element.Attributes().Where(e => e.Name == "IsISNI").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Attributes().Where(e => e.Name == "IsISNI").Select(e => e.Value).SingleOrDefault());
		}
	...
	public partial class RecordCompanyMarketShareData
	{
		...
		{
			ReleaseTypes = element.Elements().Where(e => e.Name == "ReleaseType").Select(e => new ReleaseType(e)).ToList();
			UnitsSoldTotal = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "UnitsSoldTotal").Select(e => e.Value).SingleOrDefault()) ? null : (int?)int.Parse(element.Elements().Where(e => e.Name == "UnitsSoldTotal").Select(e => e.Value).SingleOrDefault());
			UseTypes = element.Elements().Where(e => e.Name == "UseType").Select(e => new UseType(e)).ToList();
			UserInterfaceTypes = element.Elements().Where(e => e.Name == "UserInterfaceType").Select(e => new UserInterfaceType(e)).ToList();
			DistributionChannelTypes = element.Elements().Where(e => e.Name == "DistributionChannelType").Select(e => new DistributionChannelType(e)).ToList();
			CarrierTypes = element.Elements().Where(e => e.Name == "CarrierType").Select(e => new CarrierType(e)).ToList();
	...
	public partial class ResourceMusicalWorkReference
	{
		...
		public ResourceMusicalWorkReference(XElement element)
		{
			SequenceNumber = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "SequenceNumber").Select(e => e.Value).SingleOrDefault()) ? null : (int?)int.Parse(element.Elements().Where(e => e.Name == "SequenceNumber").Select(e => e.Value).SingleOrDefault());
			DurationUsed = element.Elements().Where(e => e.Name == "DurationUsed").Select(e => e.Value).SingleOrDefault();
			IsFragment = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "IsFragment").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "IsFragment").Select(e => e.Value).SingleOrDefault());
	...
	public partial class RightShare
	{
		...
		public RightShare(XElement element)
		{
			...
			RightsControllers = element.Elements().Where(e => e.Name == "RightsController").Select(e => new RightsController(e)).ToList();
			ValidityPeriod = element.Elements().Where(e => e.Name == "ValidityPeriod").Select(e => new Period(e)).SingleOrDefault() ?? new NullPeriod();
			PercentageUnknown = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "PercentageUnknown").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "PercentageUnknown").Select(e => e.Value).SingleOrDefault());
			...
			HasFirstLicenseRefusal = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "HasFirstLicenseRefusal").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "HasFirstLicenseRefusal").Select(e => e.Value).SingleOrDefault());
			LanguageAndScriptCode = element.Attributes().Where(e => e.Name == "LanguageAndScriptCode").Select(e => e.Value).SingleOrDefault();
		}
	...
	public partial class RightsController
	{
		...
		public RightsController(XElement element)
		{
			...
			RightShareUnknown = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "RightShareUnknown").Select(e => e.Value).SingleOrDefault()) ? null : (bool?)bool.Parse(element.Elements().Where(e => e.Name == "RightShareUnknown").Select(e => e.Value).SingleOrDefault());
	...
	{
		public override string Rate { get { throw this.NullAccess("Rate"); } }
	...
	public partial class Usage
	{
		...
		public Usage(XElement element)
		{
			...
			NumberOfUsages = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "NumberOfUsages").Select(e => e.Value).SingleOrDefault()) ? null : (int?)int.Parse(element.Elements().Where(e => e.Name == "NumberOfUsages").Select(e => e.Value).SingleOrDefault());
		}
