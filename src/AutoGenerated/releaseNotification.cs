...
namespace AutoGenerated2
{
	...
	public class CatalogTransfer
	{
		...
		{
			CatalogTransferCompleted = bool.Parse(element.Elements().Where(e => e.Name == "CatalogTransferCompleted").Select(e => e.Value).SingleOrDefault());
	...
	public class Collection
	{
		...
		public Collection(XElement element)
		{
			...
			IsComplete = bool.Parse(element.Elements().Where(e => e.Name == "IsComplete").Select(e => e.Value).SingleOrDefault());
	...
	public class Cue
	{
		...
		public Cue(XElement element)
		{
			...
			IsDance = bool.Parse(element.Elements().Where(e => e.Name == "IsDance").Select(e => e.Value).SingleOrDefault());
			...
			HasMusicalContent = bool.Parse(element.Elements().Where(e => e.Name == "HasMusicalContent").Select(e => e.Value).SingleOrDefault());
	...
	public class DealTerms
	{
		...
		public DealTerms(XElement element)
		{
			...
			AllDealsCancelled = bool.Parse(element.Elements().Where(e => e.Name == "AllDealsCancelled").Select(e => e.Value).SingleOrDefault());
			TakeDown = bool.Parse(element.Elements().Where(e => e.Name == "TakeDown").Select(e => e.Value).SingleOrDefault());
			TerritoryCodes = element.Elements().Where(e => e.Name == "TerritoryCode").Select(e => e.Value).ToList();
			ExcludedTerritoryCodes = element.Elements().Where(e => e.Name == "ExcludedTerritoryCode").Select(e => e.Value).ToList();
			...
			IsPromotional = bool.Parse(element.Elements().Where(e => e.Name == "IsPromotional").Select(e => e.Value).SingleOrDefault());
			...
			IsExclusive = bool.Parse(element.Elements().Where(e => e.Name == "IsExclusive").Select(e => e.Value).SingleOrDefault());
			...
			NumberOfProductsPerCarton = int.Parse(element.Elements().Where(e => e.Name == "NumberOfProductsPerCarton").Select(e => e.Value).SingleOrDefault());
	...
	public class Image
	{
		...
		public Image(XElement element)
		{
			...
			IsArtistRelated = bool.Parse(element.Elements().Where(e => e.Name == "IsArtistRelated").Select(e => e.Value).SingleOrDefault());
			...
			IsUpdated = bool.Parse(element.Attributes().Where(e => e.Name == "IsUpdated").Select(e => e.Value).SingleOrDefault());
			LanguageAndScriptCode = element.Attributes().Where(a => a.Name == "LanguageAndScriptCode").Select(a => a.Value).SingleOrDefault();
		}
	...
	public class MIDI
	{
		...
		public MIDI(XElement element)
		{
			...
			IsMedley = bool.Parse(element.Elements().Where(e => e.Name == "IsMedley").Select(e => e.Value).SingleOrDefault());
			IsPotpourri = bool.Parse(element.Elements().Where(e => e.Name == "IsPotpourri").Select(e => e.Value).SingleOrDefault());
			IsInstrumental = bool.Parse(element.Elements().Where(e => e.Name == "IsInstrumental").Select(e => e.Value).SingleOrDefault());
			IsBackground = bool.Parse(element.Elements().Where(e => e.Name == "IsBackground").Select(e => e.Value).SingleOrDefault());
			IsHiddenResource = bool.Parse(element.Elements().Where(e => e.Name == "IsHiddenResource").Select(e => e.Value).SingleOrDefault());
			IsBonusResource = bool.Parse(element.Elements().Where(e => e.Name == "IsBonusResource").Select(e => e.Value).SingleOrDefault());
			IsComputerGenerated = bool.Parse(element.Elements().Where(e => e.Name == "IsComputerGenerated").Select(e => e.Value).SingleOrDefault());
			NoSilenceBefore = bool.Parse(element.Elements().Where(e => e.Name == "NoSilenceBefore").Select(e => e.Value).SingleOrDefault());
			NoSilenceAfter = bool.Parse(element.Elements().Where(e => e.Name == "NoSilenceAfter").Select(e => e.Value).SingleOrDefault());
			PerformerInformationRequired = bool.Parse(element.Elements().Where(e => e.Name == "PerformerInformationRequired").Select(e => e.Value).SingleOrDefault());
	...
	public class PhysicalReturns
	{
		...
		{
			PhysicalReturnsAllowed = bool.Parse(element.Elements().Where(e => e.Name == "PhysicalReturnsAllowed").Select(e => e.Value).SingleOrDefault());
	...
	public class ReleaseDetailsByTerritory
	{
		...
		public ReleaseDetailsByTerritory(XElement element)
		{
			...
			Titles = element.Elements().Where(e => e.Name == "Title").Select(e => new Title(e)).ToList();
			DisplayArtists = element.Elements().Where(e => e.Name == "DisplayArtist").Select(e => new Artist(e)).ToList();
			IsMultiArtistCompilation = bool.Parse(element.Elements().Where(e => e.Name == "IsMultiArtistCompilation").Select(e => e.Value).SingleOrDefault());
			...
			Synopsis = element.Elements().Where(e => e.Name == "Synopsis").Select(e => new Synopsis(e)).SingleOrDefault() ?? new NullSynopsis();
			Characters = element.Elements().Where(e => e.Name == "Character").Select(e => new Character(e)).ToList();
			NumberOfUnitsPerPhysicalRelease = int.Parse(element.Elements().Where(e => e.Name == "NumberOfUnitsPerPhysicalRelease").Select(e => e.Value).SingleOrDefault());
			LanguageAndScriptCode = element.Attributes().Where(a => a.Name == "LanguageAndScriptCode").Select(a => a.Value).SingleOrDefault();
		}
	...
	public class ResourceGroup
	{
		...
		{
			Titles = element.Elements().Where(e => e.Name == "Title").Select(e => new Title(e)).ToList();
			SequenceNumber = int.Parse(element.Elements().Where(e => e.Name == "SequenceNumber").Select(e => e.Value).SingleOrDefault());
			DisplayArtists = element.Elements().Where(e => e.Name == "DisplayArtist").Select(e => new Artist(e)).ToList();
			ResourceContributors = element.Elements().Where(e => e.Name == "ResourceContributor").Select(e => new ResourceContributor(e)).ToList();
			IndirectResourceContributors = element.Elements().Where(e => e.Name == "IndirectResourceContributor").Select(e => new IndirectResourceContributor(e)).ToList();
			ResourceGroups = element.Elements().Where(e => e.Name == "ResourceGroup").Select(e => new ResourceGroup(e)).ToList();
	...
	public class ResourceGroupContentItem
	{
		...
		{
			SequenceNumber = int.Parse(element.Elements().Where(e => e.Name == "SequenceNumber").Select(e => e.Value).SingleOrDefault());
			SequenceSubNumber = int.Parse(element.Elements().Where(e => e.Name == "SequenceSubNumber").Select(e => e.Value).SingleOrDefault());
	...
	public class TechnicalImageDetails
	{
		...
		public TechnicalImageDetails(XElement element)
		{
			...
			ColorDepth = int.Parse(element.Elements().Where(e => e.Name == "ColorDepth").Select(e => e.Value).SingleOrDefault());
			ImageResolution = int.Parse(element.Elements().Where(e => e.Name == "ImageResolution").Select(e => e.Value).SingleOrDefault());
			IsPreview = bool.Parse(element.Elements().Where(e => e.Name == "IsPreview").Select(e => e.Value).SingleOrDefault());
	...
	public class TechnicalMidiDetails
	{
		...
		public TechnicalMidiDetails(XElement element)
		{
			TechnicalResourceDetailsReference = element.Elements().Where(e => e.Name == "TechnicalResourceDetailsReference").Select(e => e.Value).SingleOrDefault();
			Duration = element.Elements().Where(e => e.Name == "Duration").Select(e => e.Value).SingleOrDefault();
			ResourceProcessingRequired = bool.Parse(element.Elements().Where(e => e.Name == "ResourceProcessingRequired").Select(e => e.Value).SingleOrDefault());
			...
			FileAvailabilityDescriptions = element.Elements().Where(e => e.Name == "FileAvailabilityDescription").Select(e => new Description(e)).ToList();
			Files = element.Elements().Where(e => e.Name == "File").Select(e => new File(e)).ToList();
			NumberOfVoices = int.Parse(element.Elements().Where(e => e.Name == "NumberOfVoices").Select(e => e.Value).SingleOrDefault());
	...
	public class TechnicalSoundRecordingDetails
	{
		...
		public TechnicalSoundRecordingDetails(XElement element)
		{
			...
			NumberOfChannels = int.Parse(element.Elements().Where(e => e.Name == "NumberOfChannels").Select(e => e.Value).SingleOrDefault());
			...
			BitsPerSample = int.Parse(element.Elements().Where(e => e.Name == "BitsPerSample").Select(e => e.Value).SingleOrDefault());
			Duration = element.Elements().Where(e => e.Name == "Duration").Select(e => e.Value).SingleOrDefault();
			ResourceProcessingRequired = bool.Parse(element.Elements().Where(e => e.Name == "ResourceProcessingRequired").Select(e => e.Value).SingleOrDefault());
			UsableResourceDuration = element.Elements().Where(e => e.Name == "UsableResourceDuration").Select(e => e.Value).SingleOrDefault();
			IsPreview = bool.Parse(element.Elements().Where(e => e.Name == "IsPreview").Select(e => e.Value).SingleOrDefault());
	...
	public class TechnicalVideoDetails
	{
		...
		public TechnicalVideoDetails(XElement element)
		{
			...
			NumberOfAudioChannels = int.Parse(element.Elements().Where(e => e.Name == "NumberOfAudioChannels").Select(e => e.Value).SingleOrDefault());
			...
			AudioBitsPerSample = int.Parse(element.Elements().Where(e => e.Name == "AudioBitsPerSample").Select(e => e.Value).SingleOrDefault());
			Duration = element.Elements().Where(e => e.Name == "Duration").Select(e => e.Value).SingleOrDefault();
			ResourceProcessingRequired = bool.Parse(element.Elements().Where(e => e.Name == "ResourceProcessingRequired").Select(e => e.Value).SingleOrDefault());
			UsableResourceDuration = element.Elements().Where(e => e.Name == "UsableResourceDuration").Select(e => e.Value).SingleOrDefault();
			IsPreview = bool.Parse(element.Elements().Where(e => e.Name == "IsPreview").Select(e => e.Value).SingleOrDefault());
	...
	public class WebPolicy
	{
		...
		{
			Condition = element.Elements().Where(e => e.Name == "Condition").Select(e => new Condition(e)).SingleOrDefault() ?? new NullCondition();
			AccessBlockingRequested = bool.Parse(element.Elements().Where(e => e.Name == "AccessBlockingRequested").Select(e => e.Value).SingleOrDefault());
			AccessLimitation = element.Elements().Where(e => e.Name == "AccessLimitation").Select(e => e.Value).SingleOrDefault();
			EmbeddingAllowed = bool.Parse(element.Elements().Where(e => e.Name == "EmbeddingAllowed").Select(e => e.Value).SingleOrDefault());
			UserRatingAllowed = bool.Parse(element.Elements().Where(e => e.Name == "UserRatingAllowed").Select(e => e.Value).SingleOrDefault());
			UserCommentAllowed = bool.Parse(element.Elements().Where(e => e.Name == "UserCommentAllowed").Select(e => e.Value).SingleOrDefault());
			UserResponsesAllowed = bool.Parse(element.Elements().Where(e => e.Name == "UserResponsesAllowed").Select(e => e.Value).SingleOrDefault());
			SyndicationAllowed = bool.Parse(element.Elements().Where(e => e.Name == "SyndicationAllowed").Select(e => e.Value).SingleOrDefault());
		}
	...
	public class Artist
	{
		...
		public Artist(XElement element)
		{
			...
			SequenceNumber = int.Parse(element.Attributes().Where(e => e.Name == "SequenceNumber").Select(e => e.Value).SingleOrDefault());
		}
	...
	public class CollectionCollectionReferenceList
	{
		...
		{
			NumberOfCollections = int.Parse(element.Elements().Where(e => e.Name == "NumberOfCollections").Select(e => e.Value).SingleOrDefault());
	...
	public class CollectionId
	{
		...
		public CollectionId(XElement element)
		{
			...
			IsReplaced = bool.Parse(element.Attributes().Where(e => e.Name == "IsReplaced").Select(e => e.Value).SingleOrDefault());
		}
	...
	public class ConsumerRentalPeriod
	{
		...
		{
			Value = element.Value;
			IsExtensible = bool.Parse(element.Attributes().Where(e => e.Name == "IsExtensible").Select(e => e.Value).SingleOrDefault());
		}
	...
	public class EventDate
	{
		...
		{
			Value = element.Value;
			IsApproximate = bool.Parse(element.Attributes().Where(e => e.Name == "IsApproximate").Select(e => e.Value).SingleOrDefault());
			IsBefore = bool.Parse(element.Attributes().Where(e => e.Name == "IsBefore").Select(e => e.Value).SingleOrDefault());
			IsAfter = bool.Parse(element.Attributes().Where(e => e.Name == "IsAfter").Select(e => e.Value).SingleOrDefault());
	...
	public class ICPN
	{
		...
		{
			Value = element.Value;
			IsEan = bool.Parse(element.Attributes().Where(e => e.Name == "IsEan").Select(e => e.Value).SingleOrDefault());
		}
	...
	public class NumberOfSubscribers
	{
		...
		{
			Quantity = int.Parse(element.Elements().Where(e => e.Name == "Quantity").Select(e => e.Value).SingleOrDefault());
			UseTypes = element.Elements().Where(e => e.Name == "UseType").Select(e => new UseType(e)).ToList();
			UserInterfaceTypes = element.Elements().Where(e => e.Name == "UserInterfaceType").Select(e => new UserInterfaceType(e)).ToList();
			DistributionChannelTypes = element.Elements().Where(e => e.Name == "DistributionChannelType").Select(e => new DistributionChannelType(e)).ToList();
			CarrierTypes = element.Elements().Where(e => e.Name == "CarrierType").Select(e => new CarrierType(e)).ToList();
	...
	public class PartyId
	{
		...
		public PartyId(XElement element)
		{
			Value = element.Value;
			Namespace = element.Attributes().Where(a => a.Name == "Namespace").Select(a => a.Value).SingleOrDefault();
			IsDPID = bool.Parse(element.Attributes().Where(e => e.Name == "IsDPID").Select(e => e.Value).SingleOrDefault());
			IsISNI = bool.Parse(element.Attributes().Where(e => e.Name == "IsISNI").Select(e => e.Value).SingleOrDefault());
		}
	...
	public class RecordCompanyMarketShareData
	{
		...
		{
			ReleaseTypes = element.Elements().Where(e => e.Name == "ReleaseType").Select(e => new ReleaseType(e)).ToList();
			UnitsSoldTotal = int.Parse(element.Elements().Where(e => e.Name == "UnitsSoldTotal").Select(e => e.Value).SingleOrDefault());
			UseTypes = element.Elements().Where(e => e.Name == "UseType").Select(e => new UseType(e)).ToList();
			UserInterfaceTypes = element.Elements().Where(e => e.Name == "UserInterfaceType").Select(e => new UserInterfaceType(e)).ToList();
			DistributionChannelTypes = element.Elements().Where(e => e.Name == "DistributionChannelType").Select(e => new DistributionChannelType(e)).ToList();
			CarrierTypes = element.Elements().Where(e => e.Name == "CarrierType").Select(e => new CarrierType(e)).ToList();
	...
	public class ResourceMusicalWorkReference
	{
		...
		public ResourceMusicalWorkReference(XElement element)
		{
			SequenceNumber = int.Parse(element.Elements().Where(e => e.Name == "SequenceNumber").Select(e => e.Value).SingleOrDefault());
			DurationUsed = element.Elements().Where(e => e.Name == "DurationUsed").Select(e => e.Value).SingleOrDefault();
			IsFragment = bool.Parse(element.Elements().Where(e => e.Name == "IsFragment").Select(e => e.Value).SingleOrDefault());
	...
	public class RightShare
	{
		...
		public RightShare(XElement element)
		{
			...
			RightsControllers = element.Elements().Where(e => e.Name == "RightsController").Select(e => new RightsController(e)).ToList();
			ValidityPeriod = element.Elements().Where(e => e.Name == "ValidityPeriod").Select(e => new Period(e)).SingleOrDefault() ?? new NullPeriod();
			PercentageUnknown = bool.Parse(element.Elements().Where(e => e.Name == "PercentageUnknown").Select(e => e.Value).SingleOrDefault());
			...
			HasFirstLicenseRefusal = bool.Parse(element.Elements().Where(e => e.Name == "HasFirstLicenseRefusal").Select(e => e.Value).SingleOrDefault());
			LanguageAndScriptCode = element.Attributes().Where(a => a.Name == "LanguageAndScriptCode").Select(a => a.Value).SingleOrDefault();
		}
	...
	public class RightsController
	{
		...
		public RightsController(XElement element)
		{
			...
			RightShareUnknown = bool.Parse(element.Elements().Where(e => e.Name == "RightShareUnknown").Select(e => e.Value).SingleOrDefault());
	...
	public class Usage
	{
		...
		public Usage(XElement element)
		{
			...
			NumberOfUsages = int.Parse(element.Elements().Where(e => e.Name == "NumberOfUsages").Select(e => e.Value).SingleOrDefault());
		}
