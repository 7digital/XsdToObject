...
namespace AutoGenerated2
{
	...
	public partial class CatalogTransfer
	{
		...
		{
			CatalogTransferCompleted = element.Elements().Where(e => e.Name == "CatalogTransferCompleted").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
	...
	public partial class Collection
	{
		...
		public Collection(XElement element)
		{
			...
			IsComplete = element.Elements().Where(e => e.Name == "IsComplete").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
	...
	public partial class Cue
	{
		...
		public Cue(XElement element)
		{
			...
			IsDance = element.Elements().Where(e => e.Name == "IsDance").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
			...
			HasMusicalContent = element.Elements().Where(e => e.Name == "HasMusicalContent").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
	...
	public partial class DealTerms
	{
		...
		public DealTerms(XElement element)
		{
			...
			AllDealsCancelled = element.Elements().Where(e => e.Name == "AllDealsCancelled").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
			TakeDown = element.Elements().Where(e => e.Name == "TakeDown").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
			TerritoryCodes = element.Elements().Where(e => e.Name == "TerritoryCode").Select(e => e.Value).ToList();
			ExcludedTerritoryCodes = element.Elements().Where(e => e.Name == "ExcludedTerritoryCode").Select(e => e.Value).ToList();
			...
			IsPromotional = element.Elements().Where(e => e.Name == "IsPromotional").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
	...
	public partial class Image
	{
		...
		public Image(XElement element)
		{
			...
			IsArtistRelated = element.Elements().Where(e => e.Name == "IsArtistRelated").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
			...
			IsUpdated = element.Attributes().Where(e => e.Name == "IsUpdated").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
			LanguageAndScriptCode = element.Attributes().Where(e => e.Name == "LanguageAndScriptCode").Select(e => e.Value).SingleOrDefault();
		}
	...
	public partial class MIDI
	{
		...
		public MIDI(XElement element)
		{
			...
			IsMedley = element.Elements().Where(e => e.Name == "IsMedley").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
			IsPotpourri = element.Elements().Where(e => e.Name == "IsPotpourri").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
			IsInstrumental = element.Elements().Where(e => e.Name == "IsInstrumental").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
			IsBackground = element.Elements().Where(e => e.Name == "IsBackground").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
			IsHiddenResource = element.Elements().Where(e => e.Name == "IsHiddenResource").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
			IsBonusResource = element.Elements().Where(e => e.Name == "IsBonusResource").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
			IsComputerGenerated = element.Elements().Where(e => e.Name == "IsComputerGenerated").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
			NoSilenceBefore = element.Elements().Where(e => e.Name == "NoSilenceBefore").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
			NoSilenceAfter = element.Elements().Where(e => e.Name == "NoSilenceAfter").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
			PerformerInformationRequired = element.Elements().Where(e => e.Name == "PerformerInformationRequired").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
	...
	public partial class ReleaseDetailsByTerritory
	{
		...
		public ReleaseDetailsByTerritory(XElement element)
		{
			...
			Titles = element.Elements().Where(e => e.Name == "Title").Select(e => new Title(e)).ToList();
			DisplayArtists = element.Elements().Where(e => e.Name == "DisplayArtist").Select(e => new Artist(e)).ToList();
			IsMultiArtistCompilation = element.Elements().Where(e => e.Name == "IsMultiArtistCompilation").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
	...
	public partial class WebPolicy
	{
		...
		{
			Condition = element.Elements().Where(e => e.Name == "Condition").Select(e => new Condition(e)).SingleOrDefault() ?? new NullCondition();
			AccessBlockingRequested = element.Elements().Where(e => e.Name == "AccessBlockingRequested").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
			AccessLimitation = element.Elements().Where(e => e.Name == "AccessLimitation").Select(e => e.Value).SingleOrDefault();
			EmbeddingAllowed = element.Elements().Where(e => e.Name == "EmbeddingAllowed").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
			UserRatingAllowed = element.Elements().Where(e => e.Name == "UserRatingAllowed").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
			UserCommentAllowed = element.Elements().Where(e => e.Name == "UserCommentAllowed").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
			UserResponsesAllowed = element.Elements().Where(e => e.Name == "UserResponsesAllowed").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
			SyndicationAllowed = element.Elements().Where(e => e.Name == "SyndicationAllowed").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
		}
	...
	public partial class CollectionId
	{
		...
		public CollectionId(XElement element)
		{
			...
			IsReplaced = element.Attributes().Where(e => e.Name == "IsReplaced").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
		}
	...
	public partial class ConsumerRentalPeriod
	{
		...
		{
			Value = element.Value;
			IsExtensible = element.Attributes().Where(e => e.Name == "IsExtensible").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
		}
	...
	public partial class ICPN
	{
		...
		{
			Value = element.Value;
			IsEan = element.Attributes().Where(e => e.Name == "IsEan").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
		}
	...
	public partial class PartyId
	{
		...
		public PartyId(XElement element)
		{
			Value = element.Value;
			Namespace = element.Attributes().Where(e => e.Name == "Namespace").Select(e => e.Value).SingleOrDefault();
			IsDPID = element.Attributes().Where(e => e.Name == "IsDPID").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
			IsISNI = element.Attributes().Where(e => e.Name == "IsISNI").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
		}
	...
	public partial class RightShare
	{
		...
		public RightShare(XElement element)
		{
			...
			RightsControllers = element.Elements().Where(e => e.Name == "RightsController").Select(e => new RightsController(e)).ToList();
			ValidityPeriod = element.Elements().Where(e => e.Name == "ValidityPeriod").Select(e => new Period(e)).SingleOrDefault() ?? new NullPeriod();
			PercentageUnknown = element.Elements().Where(e => e.Name == "PercentageUnknown").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
			...
			HasFirstLicenseRefusal = element.Elements().Where(e => e.Name == "HasFirstLicenseRefusal").Select(e => string.IsNullOrEmpty(e.Value) ? (bool?)null : bool.Parse(e.Value)).SingleOrDefault();
			LanguageAndScriptCode = element.Attributes().Where(e => e.Name == "LanguageAndScriptCode").Select(e => e.Value).SingleOrDefault();
		}
