...
namespace AutoGenerated2
{
	public class NewReleaseMessage
	{
		...
		public NewReleaseMessage(XElement element)
		{
			...
			MessageSchemaVersionId = element.Elements().Where(e => e.Name == "MessageSchemaVersionId").Select(e => e.Value).SingleOrDefault();
			BusinessProfileVersionId = element.Elements().Where(e => e.Name == "BusinessProfileVersionId").Select(e => e.Value).SingleOrDefault();
			ReleaseProfileVersionId = element.Elements().Where(e => e.Name == "ReleaseProfileVersionId").Select(e => e.Value).SingleOrDefault();
			LanguageAndScriptCode = element.Elements().Where(e => e.Name == "LanguageAndScriptCode").Select(e => e.Value).SingleOrDefault();
		}
	...
	public class Image
	{
		...
		public Image(XElement element)
		{
			...
			IsUpdated = bool.Parse(element.Elements().Where(e => e.Name == "IsUpdated").Select(e => e.Value).SingleOrDefault());
			LanguageAndScriptCode = element.Elements().Where(e => e.Name == "LanguageAndScriptCode").Select(e => e.Value).SingleOrDefault();
		}
	...
	public class AdministratingRecordCompany
	{
		...
		public AdministratingRecordCompany(XElement element)
		{
			...
			Namespace = element.Elements().Where(e => e.Name == "Namespace").Select(e => e.Value).SingleOrDefault();
			UserDefinedValue = element.Elements().Where(e => e.Name == "UserDefinedValue").Select(e => e.Value).SingleOrDefault();
			Role = element.Elements().Where(e => e.Name == "Role").Select(e => e.Value).SingleOrDefault();
		}
	...
	public class AppliedRoyaltyRate
	{
		...
		{
			Value = element.Value;
			ValueType = element.Elements().Where(e => e.Name == "ValueType").Select(e => e.Value).SingleOrDefault();
			RoyaltyRateType = element.Elements().Where(e => e.Name == "RoyaltyRateType").Select(e => e.Value).SingleOrDefault();
			Namespace = element.Elements().Where(e => e.Name == "Namespace").Select(e => e.Value).SingleOrDefault();
			UserDefinedValue = element.Elements().Where(e => e.Name == "UserDefinedValue").Select(e => e.Value).SingleOrDefault();
		}
	...
	public class AudioCodecType
	{
		...
		{
			Value = element.Value;
			Version = element.Elements().Where(e => e.Name == "Version").Select(e => e.Value).SingleOrDefault();
			Namespace = element.Elements().Where(e => e.Name == "Namespace").Select(e => e.Value).SingleOrDefault();
			UserDefinedValue = element.Elements().Where(e => e.Name == "UserDefinedValue").Select(e => e.Value).SingleOrDefault();
		}
	...
	public class BitRate
	{
		...
		{
			Value = element.Value;
			UnitOfMeasure = element.Elements().Where(e => e.Name == "UnitOfMeasure").Select(e => e.Value).SingleOrDefault();
		}
	...
	public class CollectionId
	{
		...
		public CollectionId(XElement element)
		{
			...
			IsReplaced = bool.Parse(element.Elements().Where(e => e.Name == "IsReplaced").Select(e => e.Value).SingleOrDefault());
		}
	...
	public class ConsumerRentalPeriod
	{
		...
		{
			Value = element.Value;
			IsExtensible = bool.Parse(element.Elements().Where(e => e.Name == "IsExtensible").Select(e => e.Value).SingleOrDefault());
		}
	...
	public class DeductionRate
	{
		...
		{
			Value = element.Value;
			DeductionRateType = element.Elements().Where(e => e.Name == "DeductionRateType").Select(e => e.Value).SingleOrDefault();
			DeductionDescription = element.Elements().Where(e => e.Name == "DeductionDescription").Select(e => e.Value).SingleOrDefault();
			LanguageAndScriptCode = element.Elements().Where(e => e.Name == "LanguageAndScriptCode").Select(e => e.Value).SingleOrDefault();
		}
	...
	public class EventDate
	{
		...
		{
			Value = element.Value;
			IsApproximate = bool.Parse(element.Elements().Where(e => e.Name == "IsApproximate").Select(e => e.Value).SingleOrDefault());
			IsBefore = bool.Parse(element.Elements().Where(e => e.Name == "IsBefore").Select(e => e.Value).SingleOrDefault());
			IsAfter = bool.Parse(element.Elements().Where(e => e.Name == "IsAfter").Select(e => e.Value).SingleOrDefault());
			TerritoryCode = element.Elements().Where(e => e.Name == "TerritoryCode").Select(e => e.Value).SingleOrDefault();
			LocationDescription = element.Elements().Where(e => e.Name == "LocationDescription").Select(e => e.Value).SingleOrDefault();
			LanguageAndScriptCode = element.Elements().Where(e => e.Name == "LanguageAndScriptCode").Select(e => e.Value).SingleOrDefault();
		}
	...
	public class ExternalLocationDescriptor
	{
		...
		{
			Value = element.Value;
			DescriptorSyntax = element.Elements().Where(e => e.Name == "DescriptorSyntax").Select(e => e.Value).SingleOrDefault();
		}
	...
	public class GuaranteedAmount
	{
		...
		{
			Value = element.Value;
			CurrencyCode = element.Elements().Where(e => e.Name == "CurrencyCode").Select(e => e.Value).SingleOrDefault();
			ReferenceUnit = element.Elements().Where(e => e.Name == "ReferenceUnit").Select(e => e.Value).SingleOrDefault();
		}
	...
	public class ICPN
	{
		...
		{
			Value = element.Value;
			IsEan = bool.Parse(element.Elements().Where(e => e.Name == "IsEan").Select(e => e.Value).SingleOrDefault());
		}
	...
	public class LabelName
	{
		...
		public LabelName(XElement element)
		{
			Value = element.Value;
			LanguageAndScriptCode = element.Elements().Where(e => e.Name == "LanguageAndScriptCode").Select(e => e.Value).SingleOrDefault();
			LabelNameType = element.Elements().Where(e => e.Name == "LabelNameType").Select(e => e.Value).SingleOrDefault();
		}
	...
	public class LinkedReleaseResourceReference
	{
		...
		{
			Value = element.Value;
			LinkDescription = element.Elements().Where(e => e.Name == "LinkDescription").Select(e => e.Value).SingleOrDefault();
			LanguageAndScriptCode = element.Elements().Where(e => e.Name == "LanguageAndScriptCode").Select(e => e.Value).SingleOrDefault();
		}
	...
	public class NumberOfDataMismatchItems
	{
		...
		{
			Value = element.Value;
			DataMismatchStatus = element.Elements().Where(e => e.Name == "DataMismatchStatus").Select(e => e.Value).SingleOrDefault();
		}
	...
	public class PLine
	{
		...
		public PLine(XElement element)
		{
			...
			LanguageAndScriptCode = element.Elements().Where(e => e.Name == "LanguageAndScriptCode").Select(e => e.Value).SingleOrDefault();
			PLineType = element.Elements().Where(e => e.Name == "PLineType").Select(e => e.Value).SingleOrDefault();
		}
	...
	public class PartyId
	{
		...
		public PartyId(XElement element)
		{
			Value = element.Value;
			Namespace = element.Elements().Where(e => e.Name == "Namespace").Select(e => e.Value).SingleOrDefault();
			IsDPID = bool.Parse(element.Elements().Where(e => e.Name == "IsDPID").Select(e => e.Value).SingleOrDefault());
			IsISNI = bool.Parse(element.Elements().Where(e => e.Name == "IsISNI").Select(e => e.Value).SingleOrDefault());
		}
	...
	public class TariffReference
	{
		...
		public TariffReference(XElement element)
		{
			Value = element.Value;
			LanguageAndScriptCode = element.Elements().Where(e => e.Name == "LanguageAndScriptCode").Select(e => e.Value).SingleOrDefault();
			TariffSubReference = element.Elements().Where(e => e.Name == "TariffSubReference").Select(e => e.Value).SingleOrDefault();
		}
	...
	public class Title
	{
		...
		public Title(XElement element)
		{
			...
			LanguageAndScriptCode = element.Elements().Where(e => e.Name == "LanguageAndScriptCode").Select(e => e.Value).SingleOrDefault();
			TitleType = element.Elements().Where(e => e.Name == "TitleType").Select(e => e.Value).SingleOrDefault();
		}
	...
	public class TypedSubTitle
	{
		...
		public TypedSubTitle(XElement element)
		{
			Value = element.Value;
			LanguageAndScriptCode = element.Elements().Where(e => e.Name == "LanguageAndScriptCode").Select(e => e.Value).SingleOrDefault();
			SubTitleType = element.Elements().Where(e => e.Name == "SubTitleType").Select(e => e.Value).SingleOrDefault();
		}
