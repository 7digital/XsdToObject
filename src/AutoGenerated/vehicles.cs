...
namespace AutoGenerated
{
	...
	public partial class Car
	{
		...
		public Car(XElement element)
		{
			...
			ProductionDate = string.IsNullOrEmpty(element.Elements().Where(e => e.Name == "productionDate").Select(e => e.Value).SingleOrDefault()) ? null : (DateTime?)DateTime.Parse(element.Elements().Where(e => e.Name == "productionDate").Select(e => e.Value).SingleOrDefault());
