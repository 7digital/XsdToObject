...
namespace AutoGenerated
{
	...
	public class ColorDescription
	{
		...
		public ColorDescription(XElement element)
		{
			...
			DescriptionType = element.Attributes().Where(a => a.Name == "descriptionType").Select(a => a.Value).SingleOrDefault();
		}
	...
	public class ManufacturerName
	{
		...
		public ManufacturerName(XElement element)
		{
			Value = element.Value;
			LanguageAndScriptCode = element.Attributes().Where(a => a.Name == "LanguageAndScriptCode").Select(a => a.Value).SingleOrDefault();
			NameType = element.Attributes().Where(a => a.Name == "nameType").Select(a => a.Value).SingleOrDefault();
		}
