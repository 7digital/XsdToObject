...
namespace AutoGenerated
{
	...
	public class ColorDescription
	{
		...
		public ColorDescription(XElement element)
		{
			...
			//DescriptionType = element.Elements().Where(e => e.Name == "descriptionType").Select(e => e.Value).SingleOrDefault();
			var valueInElements = element.Elements().Where(e => e.Name == "descriptionType").Select(e => e.Value).SingleOrDefault();
			var valueInAttributes = element.Attributes().Where(a => a.Name == "descriptionType").Select(e => e.Value).SingleOrDefault();
			if (valueInElements != null)
			{
				DescriptionType = valueInElements;
			}
			else if(valueInAttributes != null)
			{
				DescriptionType = valueInAttributes;
			}
		}
	...
	public class ManufacturerName
	{
		...
		public ManufacturerName(XElement element)
		{
			Value = element.Value;
			LanguageAndScriptCode = element.Elements().Where(e => e.Name == "LanguageAndScriptCode").Select(e => e.Value).SingleOrDefault();
			NameType = element.Elements().Where(e => e.Name == "nameType").Select(e => e.Value).SingleOrDefault();
		}
